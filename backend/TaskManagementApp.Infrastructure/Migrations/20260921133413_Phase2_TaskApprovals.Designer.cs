...
namespace TaskManagementApp.Infrastructure.Migrations
{
    ...
    [Migration("20260921133413_Phase2_TaskApprovals")]
    partial class Phase2_TaskApprovals
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManagementApp.Domain.Entities.Goal", b =>
                {
            ...
            modelBuilder.Entity("TaskManagementApp.Domain.Entities.KeyResult", b =>
                {
            ...
            modelBuilder.Entity("TaskManagementApp.Domain.Entities.TaskAuditLog", b =>
                {
                    b.Property<Guid>("TaskAuditLogId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("(newid())");
            ...
            modelBuilder.Entity("TaskManagementApp.Domain.Entities.KeyResult", b =>
                {
                    b.HasOne("TaskManagementApp.Domain.Entities.Goal", "Goal")
                        .WithMany("KeyResults")
