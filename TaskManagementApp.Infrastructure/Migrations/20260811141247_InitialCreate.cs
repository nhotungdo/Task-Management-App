    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Users__1788CC4CD595993C", x => x.UserId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Activity__5E548648FA43F35A", x => x.LogId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Notifica__20CF2E122279F4A9", x => x.NotificationId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__RefreshT__658FEEEACF215749", x => x.TokenId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Tasks__7C6949B1BD70F0F7", x => x.TaskId);
                    table.ForeignKey(
                        name: "FK_Tasks_Users",
                        column: x => x.OwnerId,
                        principalTable: "Users",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TaskAssignmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "(newid())"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__TaskAssi__75E8D23F4E3E24D2", x => x.TaskAssignmentId);
                    table.ForeignKey(
                        name: "FK_TaskAssignments_Tasks",
                        column: x => x.TaskId,
                        principalTable: "Tasks",
                        principalColumn: "TaskId");
                    table.ForeignKey(
                        name: "FK_TaskAssignments_Users",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Users__A9D10534BCD41052",
                table: "Users",
                column: "Email",
                unique: true);
        }
